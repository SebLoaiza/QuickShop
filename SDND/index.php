...
$username = $isLoggedIn ? htmlspecialchars($_SESSION['usn']) : '';
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div id="navbar">
        ...
        <div id="navbar-wrap">
            ...
            <div class="widgets">
                ...
                <a href="mailto:quickshop@example.com" target="_blank">Contact</a>
    ...
    <script>
        ...
        function querySearchBar(term) {
            window.location.href = `./html/search?q=${encodeURIComponent(term)}`;
        }
    </script>
</body>
</html>
